...
In their findings, they found that people with:
  ...
  * and a Doctoral degree earned an average of $84,396/year.
  ...
  LINK: http://blog.udacity.com/2016/07/nanodegree-101.html
...
console.log(BackToSchool(education = 'no high school diploma'));
console.log(BackToSchool(education = 'a high school diploma'));
console.log(BackToSchool(education = 'an Associate\'s degree'));
console.log(BackToSchool(education = 'a Bachelor\'s degree'));
console.log(BackToSchool(education = 'a Master\'s degree'));
console.log(BackToSchool(education = 'a Professional degree'));
console.log(BackToSchool(education = 'a Doctoral degree'));